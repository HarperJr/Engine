...
void main(void){
    /*Material*/
    material.ambient = u_material[AMBIENT_C];
    material.diffuse = u_material[DIFFUSE_C];
    material.specular = u_material[SPECULAR_C];
    material.emissive = u_material[EMISSIVE_C];
